...
def index_to_position(index: Index, strides: Strides) -> int:
    ...
    Returns:
        Position in storage
    """
    return sum([stride * idx for stride, idx in zip(strides, index)])
...
def shape_broadcast(shape1: UserShape, shape2: UserShape) -> UserShape:
    ...
    for dim in range(1, max_dims + 1):  # Iterates from the end of the shapes
        # Checks if OOB in either shape
